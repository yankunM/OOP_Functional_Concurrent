...
public class GeometryTest {
    ...
    private static void testRadialGraphSymmetries() {
        ...
        boolean x = graphSymmetries.areSymmetric(g1, g2); // must return false
        System.out.println(x);
        boolean y = graphSymmetries.areSymmetric(g1, g3); // must return true
        System.out.println(y);
        boolean z = graphSymmetries.areSymmetric(g3, g4); // must return true
    ...
    private static void testSquareSymmetries() {
        ...
        boolean x = squareSymmetries.areSymmetric(sq1, sq2); // must return false
        System.out.println(x);
        boolean y = squareSymmetries.areSymmetric(sq1, sq3); // must return true
        System.out.println(y);
